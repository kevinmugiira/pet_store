        ...
        <div id="content">
            ...
            <div class="content">
                ...
                <ul class="connect">
                    <li>
                        ...
                        <p>
                            <span>E-mail: <a href="{{url('contact')}}">freewebsitetemplates.com</a></span>
            ...
            <div id="sidebar">
                ...
                <div class="connect">
                    <h2>Follow Us</h2>
                    <ul>
                        <li><a class="facebook" href="{{url('contact')}}">Facebook</a></li>
                        <li><a class="subscribe" href="{{url('contact')}}">Subscribe</a></li>
                        <li><a class="twitter" href="{{url('contact')}}">Twitter</a></li>
                        <li><a class="flicker" href="{{url('contact')}}">Flicker</a></li>
                        <ul>
                </div>
